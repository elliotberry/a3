...
const argumentNamesToMethodMap = [
   ...
   { 
    names: ["path", "pathcase"],
    method: pathCase, description: "Converts string to path/case",
    title: "Path Case"
   },
   { 
    names: ["sentence", "sentencecase"],
    method: sentenceCase, description: "Converts string to Sentence case",
    title: "Sentence Case"
   },
   { 
   ...
   { 
    names: ["camelcase", "camelCase"],
    method: camelCase, description: "Alias for camelCase conversion",
    title: "Camel Case"
   },
   { 
